...
class WriteReview2 extends StatefulWidget {
  ...
  @override
  _WriteReview2State createState() => _WriteReview2State();
}

class _WriteReview2State extends State<WriteReview2> {
  ...
  Widget rateProduct(ProductElement productElement, productIndex) {
                  ...
                  ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: productElement.type == ProductType.GIFT_CARD
                          ? FancyShimmerImage(
                              imageUrl:
                                  "${AppConfig.assetPath}/${productElement.giftCard.thumbnailImage}",
                              boxFit: BoxFit.cover,
                            )
                          : FancyShimmerImage(
                              imageUrl:
                                  "${AppConfig.assetPath}/${productElement.sellerProductSku.product.product.thumbnailImageSource}",
                              boxFit: BoxFit.cover,
                            ),
                    ),
                  ),
                      ...
                      child: Column(
                        ...
                        children: [
                          productElement.type == ProductType.GIFT_CARD
                              ...
                              : Text(
                                  productElement
                                      .sellerProductSku.product.productName,
                                  style: AppStyles.appFontBold,
                                ),
                          productElement.type != ProductType.GIFT_CARD
                              ? ListView.builder(
                                  ...
                                  Container(
                                    child: RatingBar.builder(
                                      ...
                                      onRatingUpdate: (rating) {
                                        // print(rating);
                                        // print('product_rating_${widget.productIds[productIndex]}');
                ...
                child: TextFormField(
                  ...
                  decoration: productElement.type == ProductType.GIFT_CARD
                      ...
                      : InputDecoration(
                          ...
                          hintText: 'Review'.tr +
                              ' ${productElement.sellerProductSku.product.productName}',
                          hintMaxLines: 3,
                          hintStyle: AppStyles.appFontBook.copyWith(
                            color: AppStyles.greyColorAlt,
                          ),
  ...
  void getImages(productIndex) async {
    if (list[productIndex].images.length > 6) {
      SnackBars().snackBarWarning('Max 6 files allowedddd');
    } else {
      print('len ' + list[productIndex].images.length.toString());
      print(list[productIndex].images.length > 6);
      if (list[productIndex].images.length > 6) {
        SnackBars().snackBarWarning('Max 6 files allowed');
      }
