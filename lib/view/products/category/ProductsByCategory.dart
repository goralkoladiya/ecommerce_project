...
import 'package:amazy_app/view/products/category/CategoryFilterDrawer.dart';
...
import '../../../widgets/CustomSliverAppBarWidget.dart';
...
class CategoryProductsLoadMore extends LoadingMoreBase<ProductModel> {
  ...
  CategoryProductsLoadMore(this.categoryId);
  ...
  Future<bool> loadData([bool isloadMoreAction = false]) async {
    ...
    controller = Get.put(CategoryController(categoryId));
    Dio _dio = Dio();
