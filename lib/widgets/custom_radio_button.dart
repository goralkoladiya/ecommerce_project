...
class _CustomRadioButtonState extends State<CustomRadioButton> {
  ...
  List<Widget> buildButtonsColumn() {
    ...
    for (int index = 0; index < widget.buttonLables.length; index++) {
      var button = widget.buttonLables[index].length > 2
          ? Container(
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  elevation: 0, backgroundColor: currentSelectedLabel == widget.buttonLables[index]
                      ? widget.selectedColor
                      : widget.buttonColor,
                  padding: EdgeInsets.all(4),
                  shape: widget.buttonLables[index].length > 2
